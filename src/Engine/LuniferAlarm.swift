...
class LuniferAlarm: ObservableObject {
    ...
    func scheduleAlarm(
        ...
        let alert = AlarmPresentation.Alert(
            title: "Time to wake up",   // Main text shown on the alarm popup

            // The primary button — tapping this stops the alarm completely
            stopButton: AlarmButton(
                text: "Dismiss",
                textColor: .white,
                systemImageName: "moon.zzz.fill"  // SF Symbol icon next to the text
            ),

            // The secondary button — tapping this snoozes the alarm
            // AlarmKit handles snooze automatically when this button is tapped
            secondaryButton: AlarmButton(
                text: "Snooze",
                textColor: Color(red: 0.75, green: 0.65, blue: 1.0),  // Lunifer purple
